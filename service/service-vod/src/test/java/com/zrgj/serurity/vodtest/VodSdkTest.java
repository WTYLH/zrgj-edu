package com.zrgj.serurity.vodtest;
...
import com.zrgj.aliyunvod.util.AliyunVodSDKUtils;
import org.junit.Test;

import java.util.List;

public class VodSdkTest {
    String accessKeyId = "LTAI5tMuJGJR5Z8K8oxyH8KG";
    String accessKeySecret = "qJXiLWXspqNaMGZ2qXRkMLQpUX0whd";
    ...
    public void testUploadVideo(){
        //1.音视频上传-本地文件上传
        //视频标题(必选)
        String title = "- How Does Project Submission Work - upload by sdk";
        //本地文件上传和文件流上传时，文件名称为上传文件绝对路径，如:/User/sample/文件名称.mp4 (必选)
        //文件名必须包含扩展名
        String fileName = "E:/zrgj/Day9/6 - What If I Want to Move Faster.mp4";
        //本地文件上传
